...
export const Route = createFileRoute("/services/index_poka")({
    ...
    scripts: [
      ...
      },
      {
        ...
        children: JSON.stringify({
          "@context": "https://schema.org",
          "@type": "FAQPage",
          mainEntity: services.flatMap((s) => s.faqs).map((f) => ({
            "@type": "Question",
            name: f.question,
          ...
          <div className="relative mx-auto max-w-3xl px-5 lg:px-8">
            ...
            <Reveal delay={0.1}>
              <Accordion type="single" collapsible className="mt-12">
                {services.flatMap((s) => s.faqs.map((f) => ({ ...f, service: s.shortTitle }))).map(
                  (f, i) => (
